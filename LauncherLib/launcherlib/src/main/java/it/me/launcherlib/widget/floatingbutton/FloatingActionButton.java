package it.me.launcherlib.widget.floatingbutton;
...
public class FloatingActionButton extends ImageButton {
    ...
    public void setStyckyHeader(StickyListHeadersListView stickyList){
    ...
    public void setStyckyHeader(StickyListHeadersListView stickyList, final FloatingActionButton otherButton){
    	stickyList.setOnScrollListener(new AbsListView.OnScrollListener() {
			@Override
			public void onScrollStateChanged(AbsListView view, int scrollState) {
				...
				final int currentFirstVisibleItem = view.getFirstVisiblePosition();
				if (currentFirstVisibleItem > mLastFirstVisibleItem) {
					otherButton.hide(true);
		            hide(true);
		        } else if (currentFirstVisibleItem < mLastFirstVisibleItem) {
		        	otherButton.show(true);
		        	show(true);
		        }
		        mLastFirstVisibleItem = currentFirstVisibleItem;
			}

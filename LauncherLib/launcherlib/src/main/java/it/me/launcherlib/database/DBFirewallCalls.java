...
public class DBFirewallCalls {

	private SQLiteDatabase database;
	private Database dbHelper;
	
	public DBFirewallCalls(Context context) {
	...
	public void add(String number){
		...
		database.replace(Database.TABLE_FIREWALL_CALL, null, values);
	...
	public void remove(String number){
		this.open();
		database.delete(Database.TABLE_FIREWALL_CALL, Database.COLUMN_NUMBER + "=? OR "+ Database.COLUMN_NUMBER + "=? OR "+ Database.COLUMN_NUMBER + "=?" , new String []{   number  , Firewall.PREFIX + number, number.replace(Firewall.PREFIX,"")});
		this.close();
	}
	...
	public void remove(){
		this.open();
		database.delete(Database.TABLE_FIREWALL_CALL, null, null);
		this.close();
	}
	
	public boolean has(String number){
		this.open();
		String query = "SELECT * FROM " + Database.TABLE_FIREWALL_CALL + " WHERE "  +Database.COLUMN_NUMBER+"=? OR "+Database.COLUMN_NUMBER+"=?"; 
	...
	public ArrayList<String> getNumbers() {
		...
		Cursor cursor = database.rawQuery("SELECT * FROM " + Database.TABLE_FIREWALL_CALL,null);
	    cursor.moveToFirst();
	...
	public ArrayList<String> getNumbersGroupPrefix() {
		...
		String query = "SELECT REPLACE("+Database.COLUMN_NUMBER+","+ "'"+ Firewall.PREFIX + "'" + ",'') AS number "+ 
				" FROM " + Database.TABLE_FIREWALL_CALL +
				" GROUP BY number;";

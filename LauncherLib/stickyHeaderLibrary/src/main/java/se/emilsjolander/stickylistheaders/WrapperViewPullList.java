...
import se.emilsjolander.stickylistheaders.StickyListHeadersListView.WrapperViewListLifeCycleListener;
...
public class WrapperViewPullList extends LoadMoreListView{

	interface LifeCycleListener {
		void onDispatchDrawOccurred(Canvas canvas);
	}

	private WrapperViewListLifeCycleListener mLifeCycleListener;
	...
	public WrapperViewPullList(Context context) {
		super(context);
	...
	void setLifeCycleListener(WrapperViewListLifeCycleListener lifeCycleListener) {

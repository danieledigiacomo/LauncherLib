...
public class StickyListHeadersListView extends FrameLayout {
    ...
    /* --- Children --- */
    public WrapperViewPullList mList;
    ...
    public StickyListHeadersListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mList = new WrapperViewPullList(context);
 ...
 //(A)       mList.setLifeCycleListener(new WrapperViewListLifeCycleListener());
    ...
    public class WrapperViewListLifeCycleListener implements LifeCycleListener {
